...
initialized with the `master' NFT and a datum that contains the three hashes, in
that order: Pool script, liquidity token script and pool ID script.
...
\begin{itemize}
  ...
  \item Add liquidity and then withdraw it in order to essentially swap with
    reduced fees
\end{itemize}
