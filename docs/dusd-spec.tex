...
\begin{itemize}
  ...
  \item The validator will validate the following:
    \begin{itemize}
      ...
      \item The datum has a list of tuples containing USD Price of ADA and the slot number 
        of when the price was observed.
      \item The datum list does not exceed 48 entries.
      \item The slot number of the latest two entries of the datum list are an hour
        apart.
      \item The slot number of the first entry in the datum list is within an hour of the slot number
        of the transaction.
      ...
      \item The slot number of the previous price oracle UTxO is at least an hour behind the
        transaction.
