...
\begin{itemize}
  ...
  \item The validator will validate the following:
    \begin{itemize}
      \item The UTxO is being spent by Admin.
      ...
      \item The slot number of each item in the datum list is an hour apart.
      \item There is a previous price oracle UTxO being spent.
      \item The slot number previous price oracle UTxO is at least an hour behind the
        transaction. 
      \item The previous price oracle UTxO contains the Oracle NFT.
      \item The Oracle NFT is being moved to the new Oracle UTxO.
    \end{itemize}  
  \end{itemize} 
